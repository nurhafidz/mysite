...
<body>
	<section class="menu cid-s1v2yee0nz" once="menu" id="menu1-3"> @include('publik.inc.navbar') </section>
	<section class="engine"><a href="https://mobirise.info/k">how to develop your own website</a></section>
	<section class="cid-s1v2D6cyUX mbr-fullscreen mbr-parallax-background" id="header2-4">
		<div class="mbr-overlay" style="opacity: 0.5; "></div>
		<div class="container align-center">
			<div class="row justify-content-md-center">
				<div class="mbr-white col-md-10">
					<h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">Hi ! I'm Nurhafidz</h1>
					<p class="mbr-text pb-3 mbr-fonts-style display-5"></p>
					<p><span style="font-size: 1.5rem;">I am   developer ,opening collaboration for your project</span>&nbsp;&nbsp;</p>
					<p></p>
				</div>
			</div>
		</div>
	...
	<section class="features12 cid-s1F5hj1FIX" id="features12-e">
		<div class="container"> @yield('content') </div>
	</section>
	<section class="mbr-gallery mbr-slider-carousel cid-s1F6gPYbnu" id="gallery4-f"> @yield('galeri') </section>
	<section class="features3 cid-s1ziLTnGA2" id="features3-b"> @yield('blog') </section>
	<section once="footers" class="cid-s1ziga84Do" id="footer7-8">
		<div class="container">
			<div class="media-container-row align-center mbr-white">
				<div class="row social-row">
					<div class="social-list align-right pb-2">
						<div class="soc-item">
							<a href="https://twitter.com/mobirise" target="_blank"> <span class="socicon-twitter socicon mbr-iconfont mbr-iconfont-social"></span> </a>
						</div>
						<div class="soc-item">
							<a href="https://plus.google.com/u/0/+Mobirise" target="_blank"> <span class="socicon-instagram socicon mbr-iconfont mbr-iconfont-social"></span> </a>
						</div>
					</div>
				</div>
